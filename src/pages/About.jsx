        ...
        <div className="container">
          ...
          <div className="partners-logos">
            <a href="https://innovationsfonds.g-ba.de/" target="_blank" rel="noopener noreferrer" className="partner-logo">
              <img src="/Psy-Diver_Webseite2/partners/innovationsfonds.svg" alt="Innovationsfonds des Gemeinsamen Bundesausschusses" />
            </a>
            <a href="https://www.dgppn.de/" target="_blank" rel="noopener noreferrer" className="partner-logo">
              <img src="/Psy-Diver_Webseite2/partners/dgppn.svg" alt="Deutsche Gesellschaft für Psychiatrie und Psychotherapie, Psychosomatik und Nervenheilkunde" />
            </a>
          </div>
        </div>
      </section>
