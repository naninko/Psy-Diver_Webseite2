    ...
    translation: {
      ...
      about: {
        ...
        studyDesign: {
          ...
          text: "PSY-DIVER uses a mixed-methods design. This combines the analysis of large amounts of data with personal surveys. The study design follows a participatory-generative approach and involves people affected by mental illnesses, as well as relatives and close ones of those affected and clinical professionals in core decision-making areas of the project. With the help of artificial intelligence, additional information is obtained from the digital medical records of the nine psychiatric-psychotherapeutic specialty clinics of the LVR. Only anonymized data is used; it is not possible to trace information back to individual patients. Data protection is ensured at every phase of the project, based on a data protection concept coordinated with the LVR Data Protection Officer. Compliance with scientific-ethical aspects is ensured through project consultation with the responsible Ethics Committee of the North Rhine Medical Association. Registration of the project in accordance with Article 35 of the Declaration of Helsinki in the German Clinical Trials Register (DRKS) is planned. Scientific results will be published as group analyses in fully anonymized form. Tracing back to individual persons is also not possible in this context."
        },
